...
# PBS -n
#PBS -l nodes=h09:has1gpu:ppn=32,walltime=52:00:00
...
echo running script...
# ARGS: configs, (fishnet: 0 or gcn: 1), model_size (or num layers), load_model (1; yes, 0: no), (model to load: best or last)
python -m main_noise.py ./comparison/configs_main_noise.json 1 big_model 0 last
